...
def _seed(sf):
    ...
    with UnitOfWork(sf) as uow:
        ...
        uow.transactions.add(TransactionRecord(transaction_id,cash,TransactionKind.NORMAL,Money(100_000,"JPY"),NOW,TransactionStatus.ACTIVE,metric_key="self_generated_revenue"))
        ...
        uow.bucket_allocations.add(BucketAllocationRecord(uuid.uuid4(),general,cash,Money(60_000,"JPY"),EntryType.CASH_LINKED,NOW,originating_transaction_id=transaction_id))
        uow.bucket_allocations.add(BucketAllocationRecord(uuid.uuid4(),tax,cash,Money(40_000,"JPY"),EntryType.CASH_LINKED,NOW,originating_transaction_id=transaction_id))
